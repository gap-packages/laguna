...
# laguna/doc/example.xml:44-49
gap> UnderlyingRing( KG );
GF(2)
gap> UnderlyingField( KG );
GF(2)
# laguna/doc/example.xml:56-63
...
# laguna/doc/example.xml:97-102
gap> Augmentation( x );
0*Z(2)
gap> IsUnit( KG, x );
false
# laguna/doc/example.xml:108-115
...
# laguna/doc/example.xml:119-128
...
# laguna/doc/example.xml:135-148
...
# laguna/doc/example.xml:156-164
...
# laguna/doc/example.xml:171-174
gap> AugmentationIdealNilpotencyIndex( KG );
9
# laguna/doc/example.xml:180-189
...
# laguna/doc/example.xml:246-265
...
# laguna/doc/example.xml:270-282
...
# laguna/doc/example.xml:288-297
...
# laguna/doc/example.xml:306-326
...
# laguna/doc/example.xml:332-356
